...
#include "application.h"
 ...
 TerrainRenderer::TerrainRenderer(World* world) {
...
void TerrainRenderer::update(World& world) {
...
void TerrainRenderer::render(World& world, wgpu::RenderPassEncoder &renderPass) {

//	// Select which pipeline to use
//	if (world.terrain->isWireFrame()) {
...
void TerrainRenderer::initRenderPipeline() {
